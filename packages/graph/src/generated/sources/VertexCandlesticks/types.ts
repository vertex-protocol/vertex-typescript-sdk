...
export type QueryVertexCandlesticksSdk = {
  /** null **/
  marketCandlestick: InContextSdkMethod<
    VertexCandlesticksTypes.Query['marketCandlestick'],
    VertexCandlesticksTypes.QuerymarketCandlestickArgs,
    MeshContext
  >;
  /** null **/
  marketCandlesticks: InContextSdkMethod<
    VertexCandlesticksTypes.Query['marketCandlesticks'],
    VertexCandlesticksTypes.QuerymarketCandlesticksArgs,
    MeshContext
  >;
  /** Access to subgraph metadata **/
  _meta: InContextSdkMethod<
    VertexCandlesticksTypes.Query['_meta'],
    VertexCandlesticksTypes.Query_metaArgs,
    MeshContext
  >;
};
...
export type SubscriptionVertexCandlesticksSdk = {
  /** null **/
  marketCandlestick: InContextSdkMethod<
    VertexCandlesticksTypes.Subscription['marketCandlestick'],
    VertexCandlesticksTypes.SubscriptionmarketCandlestickArgs,
    MeshContext
  >;
  /** null **/
  marketCandlesticks: InContextSdkMethod<
    VertexCandlesticksTypes.Subscription['marketCandlesticks'],
    VertexCandlesticksTypes.SubscriptionmarketCandlesticksArgs,
    MeshContext
  >;
  /** Access to subgraph metadata **/
  _meta: InContextSdkMethod<
    VertexCandlesticksTypes.Subscription['_meta'],
    VertexCandlesticksTypes.Subscription_metaArgs,
    MeshContext
  >;
};
export type VertexCandlesticksContext = {
  ['VertexCandlesticks']: {
    Query: QueryVertexCandlesticksSdk;
    Mutation: MutationVertexCandlesticksSdk;
    Subscription: SubscriptionVertexCandlesticksSdk;
  };
