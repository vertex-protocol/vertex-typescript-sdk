...
export namespace VertexCandlesticksTypes {
  ...
  export type QuerySdk = {
    ...
    marketCandlestick: InContextSdkMethod<
      ...
      QuerymarketCandlestickArgs,
      MeshContext
    >;
    /** null **/
    marketCandlesticks: InContextSdkMethod<
      Query['marketCandlesticks'],
      QuerymarketCandlesticksArgs,
      MeshContext
    >;
    /** Access to subgraph metadata **/
  ...
  export type SubscriptionSdk = {
    /** null **/
    marketCandlestick: InContextSdkMethod<
      Subscription['marketCandlestick'],
      SubscriptionmarketCandlestickArgs,
      MeshContext
    >;
    /** null **/
    marketCandlesticks: InContextSdkMethod<
      Subscription['marketCandlesticks'],
      SubscriptionmarketCandlesticksArgs,
      MeshContext
    >;
    /** Access to subgraph metadata **/
