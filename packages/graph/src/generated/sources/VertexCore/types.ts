...
export namespace VertexCoreTypes {
  ...
  export type QuerySdk = {
    ...
    modifyCollateralEvent: InContextSdkMethod<
      Query['modifyCollateralEvent'],
      QuerymodifyCollateralEventArgs,
      MeshContext
    >;
    /** null **/
    modifyCollateralEvents: InContextSdkMethod<
      Query['modifyCollateralEvents'],
      QuerymodifyCollateralEventsArgs,
      MeshContext
    >;
    /** null **/
    settlePnlEvent: InContextSdkMethod<
      Query['settlePnlEvent'],
      QuerysettlePnlEventArgs,
      MeshContext
    >;
    /** null **/
    settlePnlEvents: InContextSdkMethod<
      Query['settlePnlEvents'],
      QuerysettlePnlEventsArgs,
      MeshContext
    >;
    /** null **/
    ...
    fillOrderEvent: InContextSdkMethod<
      Query['fillOrderEvent'],
      QueryfillOrderEventArgs,
      MeshContext
    >;
    /** null **/
    fillOrderEvents: InContextSdkMethod<
      Query['fillOrderEvents'],
      QueryfillOrderEventsArgs,
      MeshContext
    >;
    /** null **/
    ...
    tradeSummary: InContextSdkMethod<
      Query['tradeSummary'],
      QuerytradeSummaryArgs,
      MeshContext
    >;
    /** null **/
    tradeSummaries: InContextSdkMethod<
      Query['tradeSummaries'],
      QuerytradeSummariesArgs,
      MeshContext
    >;
    /** null **/
    spotBalanceSummary: InContextSdkMethod<
      Query['spotBalanceSummary'],
      QueryspotBalanceSummaryArgs,
      MeshContext
    >;
    /** null **/
    spotBalanceSummaries: InContextSdkMethod<
      Query['spotBalanceSummaries'],
      QueryspotBalanceSummariesArgs,
      MeshContext
    >;
    /** null **/
    closedSpotBalance: InContextSdkMethod<
      Query['closedSpotBalance'],
      QueryclosedSpotBalanceArgs,
      MeshContext
    >;
    /** null **/
    closedSpotBalances: InContextSdkMethod<
      Query['closedSpotBalances'],
      QueryclosedSpotBalancesArgs,
      MeshContext
    >;
    /** null **/
    perpBalanceSummary: InContextSdkMethod<
      Query['perpBalanceSummary'],
      QueryperpBalanceSummaryArgs,
      MeshContext
    >;
    /** null **/
    perpBalanceSummaries: InContextSdkMethod<
      Query['perpBalanceSummaries'],
      QueryperpBalanceSummariesArgs,
      MeshContext
    >;
    /** null **/
    closedPerpBalance: InContextSdkMethod<
      Query['closedPerpBalance'],
      QueryclosedPerpBalanceArgs,
      MeshContext
    >;
    /** null **/
    closedPerpBalances: InContextSdkMethod<
      Query['closedPerpBalances'],
      QueryclosedPerpBalancesArgs,
      MeshContext
    >;
    /** null **/
    submitTransactionsEvent: InContextSdkMethod<
      Query['submitTransactionsEvent'],
      QuerysubmitTransactionsEventArgs,
      MeshContext
    >;
    /** null **/
    submitTransactionsEvents: InContextSdkMethod<
      Query['submitTransactionsEvents'],
      QuerysubmitTransactionsEventsArgs,
      MeshContext
    >;
    /** null **/
    submitSlowModeTransactionEvent: InContextSdkMethod<
      Query['submitSlowModeTransactionEvent'],
      QuerysubmitSlowModeTransactionEventArgs,
      MeshContext
    >;
    /** null **/
    submitSlowModeTransactionEvents: InContextSdkMethod<
      Query['submitSlowModeTransactionEvents'],
      QuerysubmitSlowModeTransactionEventsArgs,
      MeshContext
    >;
    /** Access to subgraph metadata **/
  ...
  export type SubscriptionSdk = {
    /** null **/
    clearinghouse: InContextSdkMethod<
      Subscription['clearinghouse'],
      SubscriptionclearinghouseArgs,
      MeshContext
    >;
    /** null **/
    clearinghouses: InContextSdkMethod<
      Subscription['clearinghouses'],
      SubscriptionclearinghousesArgs,
      MeshContext
    >;
    /** null **/
    ...
    /** null **/
    modifyCollateralEvent: InContextSdkMethod<
      Subscription['modifyCollateralEvent'],
      SubscriptionmodifyCollateralEventArgs,
      MeshContext
    >;
    /** null **/
    modifyCollateralEvents: InContextSdkMethod<
      Subscription['modifyCollateralEvents'],
      SubscriptionmodifyCollateralEventsArgs,
      MeshContext
    >;
    /** null **/
    settlePnlEvent: InContextSdkMethod<
      Subscription['settlePnlEvent'],
      SubscriptionsettlePnlEventArgs,
      MeshContext
    >;
    /** null **/
    settlePnlEvents: InContextSdkMethod<
      Subscription['settlePnlEvents'],
      SubscriptionsettlePnlEventsArgs,
      MeshContext
    >;
    /** null **/
    liquidationEvent: InContextSdkMethod<
    ...
    /** null **/
    fillOrderEvent: InContextSdkMethod<
      Subscription['fillOrderEvent'],
      SubscriptionfillOrderEventArgs,
      MeshContext
    >;
    /** null **/
    fillOrderEvents: InContextSdkMethod<
      Subscription['fillOrderEvents'],
      SubscriptionfillOrderEventsArgs,
      MeshContext
    >;
    /** null **/
    subaccount: InContextSdkMethod<
      Subscription['subaccount'],
      SubscriptionsubaccountArgs,
      MeshContext
    >;
    /** null **/
    subaccounts: InContextSdkMethod<
      Subscription['subaccounts'],
      SubscriptionsubaccountsArgs,
      MeshContext
    >;
    /** null **/
    tradeSummary: InContextSdkMethod<
      Subscription['tradeSummary'],
      SubscriptiontradeSummaryArgs,
      MeshContext
    >;
    /** null **/
    tradeSummaries: InContextSdkMethod<
      Subscription['tradeSummaries'],
      SubscriptiontradeSummariesArgs,
      MeshContext
    >;
    /** null **/
    spotBalanceSummary: InContextSdkMethod<
      Subscription['spotBalanceSummary'],
      SubscriptionspotBalanceSummaryArgs,
      MeshContext
    >;
    /** null **/
    spotBalanceSummaries: InContextSdkMethod<
      Subscription['spotBalanceSummaries'],
      SubscriptionspotBalanceSummariesArgs,
      MeshContext
    >;
    /** null **/
    closedSpotBalance: InContextSdkMethod<
      Subscription['closedSpotBalance'],
      SubscriptionclosedSpotBalanceArgs,
      MeshContext
    >;
    /** null **/
    closedSpotBalances: InContextSdkMethod<
      Subscription['closedSpotBalances'],
      SubscriptionclosedSpotBalancesArgs,
      MeshContext
    >;
    /** null **/
    perpBalanceSummary: InContextSdkMethod<
      Subscription['perpBalanceSummary'],
      SubscriptionperpBalanceSummaryArgs,
      MeshContext
    >;
    /** null **/
    perpBalanceSummaries: InContextSdkMethod<
      Subscription['perpBalanceSummaries'],
      SubscriptionperpBalanceSummariesArgs,
      MeshContext
    >;
    /** null **/
    closedPerpBalance: InContextSdkMethod<
      Subscription['closedPerpBalance'],
      SubscriptionclosedPerpBalanceArgs,
      MeshContext
    >;
    /** null **/
    closedPerpBalances: InContextSdkMethod<
      Subscription['closedPerpBalances'],
      SubscriptionclosedPerpBalancesArgs,
      MeshContext
    >;
    /** null **/
    submitTransactionsEvent: InContextSdkMethod<
      Subscription['submitTransactionsEvent'],
      SubscriptionsubmitTransactionsEventArgs,
      MeshContext
    >;
    /** null **/
    submitTransactionsEvents: InContextSdkMethod<
      Subscription['submitTransactionsEvents'],
      SubscriptionsubmitTransactionsEventsArgs,
      MeshContext
    >;
    /** null **/
    submitSlowModeTransactionEvent: InContextSdkMethod<
      Subscription['submitSlowModeTransactionEvent'],
      SubscriptionsubmitSlowModeTransactionEventArgs,
      MeshContext
    >;
    /** null **/
    submitSlowModeTransactionEvents: InContextSdkMethod<
      Subscription['submitSlowModeTransactionEvents'],
      SubscriptionsubmitSlowModeTransactionEventsArgs,
      MeshContext
    >;
    /** Access to subgraph metadata **/
