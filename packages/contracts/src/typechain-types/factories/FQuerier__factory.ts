...
export class FQuerier__factory {
  ...
  static createInterface(): FQuerierInterface {
    return new Interface(_abi) as FQuerierInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): FQuerier {
    return new Contract(address, _abi, runner) as unknown as FQuerier;
  }
}
